...
public class HateoasTestController {
    ...
    * */
    ...
    public HateoasTestController() {
        ...
        users.add(new UserDTO(1,"user01","pass01","이지은", LocalDate.now()));
        users.add(new UserDTO(2,"user02","pass02","이지은2", LocalDate.now()));
        users.add(new UserDTO(3,"user03","pass03","이지은3", LocalDate.now()));
    }
    ...
    public ResponseEntity<ResponseMessage> findAllUsers() {
        ...
        /* EntityModel : Hateoas 에서 제공하는 클래스로 RESTapi 를 만들 떄 해당 리소스와 관련 된 링크를 포함할 수 있게 함 */
